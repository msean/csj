...
type Customer struct {
	...
	OrderCount  int64   `gorm:"column:order_count;default:0;comment:有效订单总数" json:"orderCount"`
	TotalAmount float64 `gorm:"column:total_amount;type:decimal(12,2);default:0;comment:订单总金额" json:"totalAmount"`
}
