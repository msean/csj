...
type (
	Batch struct {
		BaseModel
		OwnerUser   int64  `gorm:"column:owner_user;comment:所属用户"`
	...
	BatchGoods struct {
		BaseModel
		OwnerUser int64   `gorm:"column:owner_user;comment:所属用户"`
		BatchUUID int64   `gorm:"column:batch_uuid;comment:货品uuid"`
		SerialNo  string  `gorm:"column:serial_no;comment:批次序号" json:"serialNo"`
		GoodsUUID int64   `gorm:"column:goods_uuid;comment:货品uuid"`
