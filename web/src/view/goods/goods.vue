    ...
    <div>
      ...
      <div class="gva-table-box">
        ...
        <el-table ref="multipleTable" style="width: 100%" tooltip-effect="dark" :data="tableData" row-key="ID"
          ...
          <el-table-column align="left" label="创建日期" prop="createTime" width="180">
            <template #default="scope">{{ formatDate(scope.row.createTime) }}</template>
          </el-table-column>
          <el-table-column align="left" label="所属用户" prop="ownerUser" width="300" />
          <el-table-column align="left" label="uid" prop="uuid" width="300" />
          <el-table-column align="left" label="菜品名称" prop="name" width="120" />
          <el-table-column align="left" label="所属分类" prop="category" width="120" />
          <el-table-column align="left" label="类别" prop="type" width="120" />
