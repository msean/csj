    ...
    <div class="gva-search-box">
      ...
      <el-date-picker
          ...
          />
            ...
            <el-form-item label="禁用内容" prop="ban_content">
  <el-input v-model="searchInfo.ban_content" placeholder="搜索条件" />
</el-form-item>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="日期" prop="createdAt" width="180">
            ...
            <el-table-column align="left" label="禁用内容" prop="ban_content" width="120" />

            <el-table-column align="left" label="机器人" prop="bot_id" width="120" />
    ...
    <el-drawer destroy-on-close :size="appStore.drawerSize" v-model="dialogFormVisible" :show-close="false" :before-close="closeDialog">
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            <el-form-item label="禁用内容:" prop="ban_content">
    <el-input v-model="formData.ban_content" :clearable="true" placeholder="请输入禁用内容" />
</el-form-item>
            <el-form-item label="机器人:" prop="bot_id">
    <el-input v-model.number="formData.bot_id" :clearable="true" placeholder="请输入机器人" />
</el-form-item>
          </el-form>
    </el-drawer>
...
const getTableData = async() => {
  const table = await getBotBanContentList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
