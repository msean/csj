...
var customersService = service.ServiceGroupApp.Csj_customersServiceGroup.CustomersService
...
func (customersApi *CustomersApi) CreateCustomers(c *gin.Context) {
	var customers csj_customers.Customers
...
func (customersApi *CustomersApi) GetCustomersList(c *gin.Context) {
	var pageInfo csj_customersReq.CustomersSearch
